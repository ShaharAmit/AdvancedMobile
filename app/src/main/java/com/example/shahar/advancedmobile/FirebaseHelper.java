...
class FirebaseHelper {
        ...
        static void saveBoardMessageInFirebase(String ref, String s) {
        ...
        private static void saveInFirebase(CurrentUser ref) {
         ...
         */
        static void wireSomeFirebaseTable(final String ref, final Class callbackType) {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if (userOnServer != null) {
                                        ...
                                        if (userDataClientSide != null) {
                                                ...
                                                if (!userDataClientSide.getUid().equals(uid)) {
